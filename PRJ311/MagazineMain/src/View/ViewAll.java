...
public class ViewAll extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        magazineTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Magazine ID", "Tittle", "Publisher", "Price"
            }
        ) {
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Vector<Vector> data = MagazineDB.getAll();
        DefaultTableModel dtm = (DefaultTableModel) magazineTable.getModel();
        dtm.setNumRows(0);
        Vector v;
