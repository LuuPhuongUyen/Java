<!DOCTYPE html>
<!-- saved from url=(0045)http://us-123charity.simplesite.com/422328016 -->
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="s" uri="/struts-tags"%>
<html lang="en-US" class="">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Contact - us-123charity.simplesite.com</title>
        ...
        <meta property="og:url" content="http://us-123charity.simplesite.com/422328016">
        <meta property="og:title" content="Contact">
        <meta property="og:image" content="http://maps.googleapis.com/maps/api/staticmap?center=56.26392%2c9.50178500000004&amp;zoom=6&amp;size=1200x630&amp;maptype=roadmap&amp;sensor=false&amp;markers=56.26392%2c9.50178500000004">
        <meta property="og:updated_time" content="2016-06-19T13:09:21.6355602+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Contact - us-123charity.simplesite.com_files/9767413.design.v27169.css">
        ...
        <script type="text/javascript" async="" src="./Contact - us-123charity.simplesite.com_files/analytics.js"></script><script async="" src="./Contact - us-123charity.simplesite.com_files/gtm.js"></script><script type="text/javascript" src="./Contact - us-123charity.simplesite.com_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Contact - us-123charity.simplesite.com_files/frontendApp.min.js"></script>
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="row-fluid map-page-info">
                                                <div class="span6">
                                                    <div class="item">
                                                        <div class="heading">
                                                            <h4 class="item-title map-page-title">Children's Charity School</h4>
                                                        </div>
                                                        <div class="content">                                                           
                                                            <div class="content">    
                                                                    ...
                                                                    <div class="content">                                                        
                                                                        ...
                                                                        <div class="country">
                                                                            <p>Address: ${con.getAddress()}<br>City: ${con.getCity()}<br>Country:${con.getCountry()}</p>
                                                                        </div>
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <div class="map-container">
                                                <div id="mapCanvas" data-ss="map" class="google-map" data-zoom="6" data-lat="56.26392" 
                                                     data-lng="9.50178500000004" data-maptype="roadmap" data-bubbletext="" data-showbubble="True" 
                                                     data-culture="en-US">
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <input id="social_hash" type="hidden" value="b=DE6C535A9C9F129249ECB5B0825329F2631DB760">
                                    </div>
                                </div>
                                <div class="wrapper viral-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom">
                                            <a rel="nofollow" href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3arightbanner&amp;referercustomerid=15831186&amp;refererpageid=422328016" class="btn btn-block">Try it for FREE now</a>
                                        </div>
