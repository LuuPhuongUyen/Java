...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <link href="How to Help_files/styleManage.css" rel="stylesheet" type="text/css"/>
        <script type="text/javascript" async="" src="./How to Help_files/analytics.js.download"></script>
        <script async="" src="./How to Help_files/gtm.js.download"></script>
        <script type="text/javascript" src="./How to Help_files/FrontendAppLocalePage.aspx"></script>
                                ...
                                <div class="content">
                                    <div class="section">
                                        <div class="manageTable">
                                            <form action="getAllMessageAction">
                                                <table border="1">
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
