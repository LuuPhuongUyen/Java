<!DOCTYPE html>
<!-- saved from url=(0045)http://us-123charity.simplesite.com/422328015 -->
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib prefix="s" uri="/struts-tags"%>
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>How to Help - us-123charity.simplesite.com</title>
        ...
        <meta property="og:url" content="http://us-123charity.simplesite.com/422328015">
        <meta property="og:title" content="How to Help">
        <meta property="og:description" content="Thank you for your interest in helping our school - 
              Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. 
              Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit
              lobortis nisl ut ali...">
        <meta property="og:image" content="http://cdn.simplesite.com/i/d2/f3/285415634679428050/i285415639381953180._szw1280h1280_.jpg">
        <meta property="og:updated_time" content="2017-01-04T04:32:36.8510271+00:00">
        ...
        <link rel="stylesheet" type="text/css" href="./How to Help_files/9767413.design.v27169.css">
        <link rel="canonical" href="http://us-123charity.simplesite.com/422328015">
        ...
        <link href="How to Help_files/style.css" rel="stylesheet" type="text/css"/>
        <script type="text/javascript" async="" src="./How to Help_files/analytics.js.download"></script><script async="" src="./How to Help_files/gtm.js.download"></script><script type="text/javascript" src="./How to Help_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./How to Help_files/frontendApp.min.js.download"></script>
    ...
    <body data-pid="422328015" data-iid="">
                                ...
                                <div class="content">
                                    <form action="getHelp">
                                        <div class="section">
                                            ...
                                            <c:forEach items="${lsInfo}" var="ls">
                                                <div class="content">
                                                    <div class="span12 contact-text">
                                                        <h4>${ls.getTitle()}</h4>
                                                        <p><span>${ls.getContent()}</span></p>
                                                    </div>
                                                    <div class="img-simple span6 ">
                                                        <div class="image">
                                                            <a rel="nofollow" data-ss="imagemodal"
                                                               data-href="http://cdn.simplesite.com/i/d2/f3/285415634679428050/i285415639381953180._szw1280h1280_.jpg">
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content"><span><ul>
                                                <li><a id="share-facebook" href="http://us-123charity.simplesite.com/422328015#"><i class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
                                                <li><a id="share-twitter" href="http://us-123charity.simplesite.com/422328015#"><i class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
                                                <li><a id="share-google-plus" href="http://us-123charity.simplesite.com/422328015#"><i class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>    
                                            </ul></span></div>
                                </div>
                                <div class="wrapper viral-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom">
                                            <a rel="nofollow" href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3arightbanner&amp;referercustomerid=15831186&amp;refererpageid=422328015" class="btn btn-block">Try it for FREE now</a>
                                        </div>
                ...
                <div class="container">
                    <div class="footer-info">
                        ...
                        <div class="footer-powered-by">
                            <a rel="nofollow" href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=15831186&amp;refererpageid=422328015">Get Your own FREE website. Click here!</a>
                        </div>
                    </div>
