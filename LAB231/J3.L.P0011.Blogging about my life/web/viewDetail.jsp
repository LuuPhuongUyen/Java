<%-- 
    Document   : viewDetail
    Created on : Sep 16, 2020, 2:57:36 PM
    Author     : PC
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="blogModel.blog"%>
...
<html lang="en-US">
    <head>
        ...
        <meta property="og:url" content="http://us-123my-life.simplesite.com/422328564/3232872/posting/" />
        <meta property="og:title" content="You&#39;ve gotta dance" />
        <meta property="og:description" content="&quot;?You&#39;ve gotta dance like there&#39;s nobody watching,
              Love like you&#39;ll never be hurt,
              Sing like there&#39;s nobody listening,
              And live like it&#39;s heaven on earth.? &quot; - William W. Purkey" />
        <meta property="og:updated_time" content="2019-10-21T02:45:36.9635324Z" />
        ...
        <link rel="canonical" href="http://us-123my-life.simplesite.com/422328564/3232872/posting/" />
        ...
        <link rel="icon" sizes="194x194" href="/favicon-194x194.png">51 <link rel="icon" sizes="192x192" href="/android-chrome-192x192.png">
    ...
    <body data-pid="422328564" data-iid="3232872" style="line-height: normal;" class="stefan-asafti">
        ...
        <div class="container-fluid site-wrapper">
            ...
            <div class="container-fluid content-wrapper" id="content"> <!-- this is the Content Wrapper -->
                            ...
                            <div class="wrapper blog-post">
                                <div class="content">
                                    ...
                                    <div class="blog-post-body section"> 
                                        ...
                                        blog b = new blog();
                                        b.getBlogByID(b_id);
                                        if (b.getType() != null && b.getType().equals("blog")) {
                                        %>
                                        <div class="controls">
                                            <span class="date-text"><%=b.getDate()%></span>
                                        </div>
                                        <div class="heading">

                                            <h1 class="page-title"><%=b.getName()%></h1>
                                        </div>
                                            ...
                                            <div class="img-simple span6 pull-left">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal"
                                                       datahref="http://cdn.simplesite.com/i/2b/ac/283445309157387307/i283445314544979646._szw1280h1280_.jpg">
                                                        <img src="<%=b.getImage()%>">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <%
                                            ...
                                            if (b.getType() != null && b.getType().equals("poem")) {
                                        %>
                                        <div class="controls">
                                            <span class="date-text"><%=b.getDate()%></span>
                                        </div>
                                        ...
                                        <%
                                            ...
                                            if (b.getType() != null && b.getType().equals("photo")) {
                                        %>
                                        <div class="controls">
                                            <span class="date-text"><%=b.getDate()%></span>
                                        </div>
                                        ...
                                        <div class="content">
                                            <div class="img-simple ">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" datahref="http://cdn.simplesite.com/i/2b/ac/283445309157387307/i283445314544979644._szw1280h1280_.jpg">
                                                        <img src="<%=b.getImage()%>"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <%
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom">
                                            <a rel="nofollow noopener noreferrer"
                                               ...
                                               422328564&utm_source=userpage&utm_medium=organic&utm_content=footerbanner" 
                ...
                </div> </div> <!-- the controller has determined which view to be shown in the content -->
        ...
        <script type="text/javascript">if (typeof window.jQuery == "undefined") {
            (function () {280 var a = document.createElement("script");
        ...
        <script type="text/javascript">
             ...
             */(function (e, t, n) {
            var r = .4, i = {use_html5_location: !1, ipinfodb_key: !1, gapi_location: !0, location_cookie: "location",
            ...
            var t = {api_version: r, locale: u.locale(), current_session: u.session(), original_session: u.session(i.session_cookie,
                    i.session_timeout * 24 * 60 * 60 * 1e3), browser: u.browser(), plugins: u.plugins(), time: u.time(), device: u.device()};
            i.use_html5_location ? t.location = u.html5_location() : i.ipinfodb_key ? t.location =
            ...
            e.session = {};
            for (var l in t) {
            o = t[l]; 339 if (typeof o == "function")
                    try {
                    o(function (t) {
                    e.session[l] = t, s--, f()
                    }), s++
            ...
            return {browser: this.search(this.data.browser), version: this.search(n.userAgent) || this.search(n.appVersion), os:
            ...
            if (n.indexOf(e[t].subString) != - 1)
            ...
            }, data: {browser: [{string: n.userAgent, subString: "Chrome", identity: "Chrome"}, {string: n.userAgent, subString:
                    ...
                    return e.setMonth(0), e.setDate(1), t.setMonth(6), t.setDate(1), {tz_offset: - (new Date).getTimezoneOffset() / 60,
                    ...
                    return e.length == 2 ? {country: e[1].toLowerCase(), lang: e[0].toLowerCase()} : e ? {lang: e[0].toLowerCase(),
                            country: null} : {lang: null, country: null}
                    }, device: function () {
                    var r = {screen: {width: screen.width, height: screen.height}}, i = t.documentElement, s =
                            t.getElementsByTagName("body")[0];
                    return r.viewport = {width: e.innerWidth || t.documentElement.clientWidth || t.body.clientWidth, height:
                            e.innerHeight || t.documentElement.clientHeight || t.body.clientHeight}, r.is_tablet = !!n.userAgent.match(/(iPad|SCHI800|xoom|kindle)/i), r.is_phone = !r.isTablet && !!n.userAgent.match(/(iPhone|iPod|blackberry|android
                    ...
                    var e = function (e) {382 if (n.plugins) {
                    ...
                    var i = a.get_obj(n);
                    if (i == null) {
                    i = {visits: 1, start: (new Date).getTime(), last_visit: (new Date).getTime(), url: e.location.href, path:
                    ...
                    i.search.engine = u.name, i.search.query = i.referrer_info.query[u.query], i.search.terms = i.search.query ?
                    ...
                    "google" in e && (e.google.loader.ClientLocation ? (e.google.loader.ClientLocation.source = "google",
                    ...
                    if (e.statusCode === "OK")437 e.source = "ipinfodb", a.set_cookie(i.location_cookie, a.package_obj(e), i.location_cookie * 60 * 60 * 1e3),
                            n(e);
                    else {
                    if (i.gapi_location)
            ...
            return {host: n.host, path: n.pathname, protocol: n.protocol, port: n.port === "" ? 80 : n.port, search: n.search,
                    query: r}
            ...
            if (r === null || r === undefined)
                    i = - 1;
            return i && (s.expires = (new Date).getTime() + i), document.cookie = [encodeURIComponent(n), "=",
            ...
            return (t = (new RegExp("(?:^|; )" + encodeURIComponent(e) + "=([^;]*)")).exec(document.cookie)) ?
            ...
            for (n in e)
                    r = e[n], t = typeof r, t === "string" ? r = '"' + r + '"' : t === "object" && r !== null && (r = this.stringify(r)),
                    i.push((s ? "" : '"' + n + '":') + r);
            return (s ? "[" : "{") + i.join(",") + (s ? "]" : "}")
            }
            if (t === "string")
