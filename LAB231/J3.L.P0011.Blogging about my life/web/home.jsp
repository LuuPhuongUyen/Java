...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script async="" src="./home_files/gtm.js.download"></script><script type="text/javascript" src="./home_files/FrontendAppLocalePage.aspx"></script>
                                ...
                                <div class="nav-collapse collapse">
                                    <ul class="nav" id="topMenu" data-submenu="horizontal">
                                        <li class=" active " style="">
                                            <a rel="nofollow" href="home.jsp">My Blog</a>
                                        </li><li class="  " style="">
                                            <a rel="nofollow" href="aboutMe.jsp">About Me</a>
                                        </li>                </ul>
                                </div>
                            </div>
                        </div>
