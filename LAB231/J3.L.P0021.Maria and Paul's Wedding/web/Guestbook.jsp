...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:description" content="Charlotte Robert - Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum. Mirum est not... - 27-10-2015 - Andr̩ Martin - Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima et quin...">
        ...
        <link rel="stylesheet" type="text/css" href="./Guestbook - www.simplesite.com_us-123wedding_files/3731000.design.v25490.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123wedding/146239002">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./Guestbook - www.simplesite.com_us-123wedding_files/analytics.js"></script><script async="" src="./Guestbook - www.simplesite.com_us-123wedding_files/gtm.js"></script><script type="text/javascript" src="./Guestbook - www.simplesite.com_us-123wedding_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Guestbook - www.simplesite.com_us-123wedding_files/frontendApp.min.js"></script>
                    ...
                    <div class="row-fluid content-inner">
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper guest-book">
                                <div class="controls">
                                    <button id="guestbook-add-message" class="btn" type="button">Add a message - Click here!</button>
                                </div>
                                <div class="heading">
                                ...
                                <div class="content">
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <form action="getGuestBook">
                                                <c:forEach items="${lsGuest}" var="g">
                                                    <div class="item">
                                                        <div class="controls">
                                                            <a rel="nofollow" class="email" href="${g.email}">Email</a>
                                                            <span class="date-text">${g.dateAdded}</span>
                                                        </div>
                                                        <div class="heading">
                                                            <h4>${g.name}</h4>
                                                        </div>
                                                        <div class="content">
                                                            <div class="img-simple span4 pull-left">
                                                                <div class="image">
                                                                    <a rel="nofollow" data-ss="imagemodal" data-href="${g.imgLink}"><img src="${g.imgLink}"></a>
                                                                </div>
                                                            </div>
                                                            <p>${g.content}</p>
                                                        </div>
