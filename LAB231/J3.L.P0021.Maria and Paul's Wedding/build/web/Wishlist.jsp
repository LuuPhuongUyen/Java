...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:description" content="
              Claritas est etiam processus (www.weddingshop.com)
              Eodem modo typi nobis videntur parum
              Duis autem vel eum iriure dolor
              Claritas est etiam processus
              Eodem modo typi nobis videntur parumÂ (www.weddingshop.com)
        ...
        <link rel="stylesheet" type="text/css" href="./Wishlist - www.simplesite.com_us-123wedding_files/3731000.design.v25490.css">
        <link rel="canonical" href="http://www.simplesite.com/us-123wedding/146239000">
        <link rel="shortcut icon" href="data:image/x-icon;,">
        <script type="text/javascript" async="" src="./Wishlist - www.simplesite.com_us-123wedding_files/analytics.js"></script><script async="" src="./Wishlist - www.simplesite.com_us-123wedding_files/gtm.js"></script><script type="text/javascript" src="./Wishlist - www.simplesite.com_us-123wedding_files/FrontendAppLocalePage.aspx"></script>
        <script type="text/javascript" src="./Wishlist - www.simplesite.com_us-123wedding_files/frontendApp.min.js"></script>
                            ...
                            <div class="wrapper ">
                                <div class="content">
                                    <div class="section article">
                                        ...
                                        <div class="content">
                                            <form action="getWishlist">
                                                <c:forEach items="${lsWish}" var="ls">                                                                                                                                                   
                                                    <p><span style="font-size: 16px;" data-mce-mark="1">${ls.content}</span></p>                                              
                                                    </c:forEach>
                                            </form>
                                        </div>
                                    </div>
