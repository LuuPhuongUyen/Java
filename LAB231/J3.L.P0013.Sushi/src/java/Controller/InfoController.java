...
public class InfoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setAttribute("address", idb.getAddress(info));
            request.setAttribute("tel", idb.getTel(info));
            request.setAttribute("mail", idb.getMail(info));
            request.setAttribute("openHours", idb.getOpenHours(info));
            request.setAttribute("map", idb.getUrlCover(info));
